// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MainActivity.cs" company="Diego Arenas T.">
//  © All rights reserved
// </copyright>
// <summary>
//   Main Activity
...
namespace XamarinNinjaCourse.Mobile.Droid
{
    using Android.App;
    ...
    [Activity(Label = "XamarinNinjaCourse.Mobile", Icon = "@mipmap/icon", Theme = "@style/MainTheme", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation | ConfigChanges.UiMode | ConfigChanges.ScreenLayout | ConfigChanges.SmallestScreenSize )]
